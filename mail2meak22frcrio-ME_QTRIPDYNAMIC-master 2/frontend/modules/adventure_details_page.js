...
function addAdventureDetailsToDOM(adventure) {
  ...
  adventure.images.map((images)=>{
    ...
    ele.innerHTML = `<img src= ${images} class="activity-card-image pb-3 md-0"/>`
...
images.map((image, idx) => { 
  ...
  ele.innerHTML = `<img src="${image}" alt="" srcset="" class="activity-card-image pb-3 mb-0"/>`;
